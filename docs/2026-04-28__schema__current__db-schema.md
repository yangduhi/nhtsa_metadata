# 2026-04-28 | Schema | CURRENT | DB Schema
...
Full-scale/PostgreSQL index candidates are documented in `docs/phase_reports/2026-04-30__schema-v1-x__accepted__schema-v1-0-index-and-read-model-plan.md` and require measured need before migration.
